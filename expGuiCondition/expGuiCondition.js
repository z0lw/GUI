...
var expGuiCondition = function (pObject, config) {
    ...
    */
    ...
    this.CONDITION_ANSWERCOUNT = "answerCount";
    this.CONDITION_SORTTYPE = "sortType";
    this.CONDITION_PRICETYPE = "priceType";
    this.CONDITION_PLANE = "plane";
    this.CONDITION_SHINKANSEN = "shinkansen";
    this.CONDITION_SHINKANSENNOZOMI = "shinkansenNozomi";
    this.CONDITION_SLEEPERTRAIN = "sleeperTrain";
    this.CONDITION_LIMITEDEXPRESS = "limitedExpress";
    this.CONDITION_HIGHWAYBUS = "highwayBus";
    this.CONDITION_CONNECTIONBUS = "connectionBus";
    this.CONDITION_LOCALBUS = "localBus";
    this.CONDITION_SHIP = "ship";
    this.CONDITION_LINER = "liner";
    this.CONDITION_WALK = "walk";
    this.CONDITION_MIDNIGHTBUS = "midnightBus";
    this.CONDITION_SURCHARGEKIND = "surchargeKind";
    this.CONDITION_TEIKIKIND = "teikiKind";
    this.CONDITION_JRSEASONALRATE = "JRSeasonalRate";
    this.CONDITION_STUDENTDISCOUNT = "studentDiscount";
    //this.CONDITION_AIRFARE = "airFare";
    //this.CONDITION_INCLUDEINSURANCE = "includeInsurance";
    this.CONDITION_TICKETSYSTEMTYPE = "ticketSystemType";
    this.CONDITION_NIKUKANTEIKI = "nikukanteiki";
    this.CONDITION_OFFPEAKTEIKI = "offpeakTeiki";
    this.CONDITION_USEJR = "useJR";
    this.CONDITION_TRANSFER = "transfer";
    this.CONDITION_EXPRESSSTARTINGSTATION = "expressStartingStation";
    this.CONDITION_WAITAVERAGETIME = "waitAverageTime";
    this.CONDITION_LOCALBUSONLY = "localBusOnly";
    //this.CONDITION_FUZZYLINE = "fuzzyLine";
    this.CONDITION_TRANSFERTIME = "transferTime";
    //this.CONDITION_ENTRYPATHBEHAVIOR = "entryPathBehavior";
    this.CONDITION_PREFERREDTICKETORDER = "preferredTicketOrder";
